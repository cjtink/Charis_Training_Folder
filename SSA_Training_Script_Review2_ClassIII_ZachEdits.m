...
title('Class III: RNA Changes with time')
xlabel('Time')
ylabel('RNA')
...
hold on
histogram(x_C1(2,:),50)
title('Class III: Probability of RNA at t-stop')
xlabel('RNA')
ylabel('Probability')
hold off
